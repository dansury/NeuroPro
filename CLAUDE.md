...
www/                  # ← веб-корень; ровно это зеркалится на прод через pull.php
  lib/
    ...
    chart.php         # МАТЕМАТИЧЕСКАЯ радар-диаграмма (SVG): единая процентная шкала —
                      ...
                      #   на кольце 50 %, p<0.05 — жирная точка)
    matrix.php        # МАТЕМАТИЧЕСКАЯ матрица «когниция × эмоция» (SVG): X — ответы
                      #   теста в единицах теста, Y — «Знач.» (медиана по центру),
                      #   бледный пунктир — пороги 40/60 % и полоса медианы, цвет
                      #   кружка по СМК (Y красный, X синий, Z зелёный; фоновые —
                      #   бледно-серые), размер — сумма когнитивного и эмоционального
                      #   ответа. В отчёте клиента она стоит ВМЕСТО таблиц
    ...
    prompts/          # Тексты автосидируемых версий промптов: *_v1.php (исходные,
                      ...
                      #   *_v4.php (активные: + итоги методики и зоны матрицы, таблиц
                      #   в отчёте нет, модель только пишет текст)
