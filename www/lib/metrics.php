...
final class Metrics {
        ...
        'bd' => [
            ...
            'hidden' => [
                ...
                'meaning' => 'левый верхний угол матрицы: в ответах теста форма ниже порога, а тело откликается. '
                    . 'Возможно, клиент справился с этими видами агрессии в поведении или в мыслях, но всё ещё склонен '
                    . 'к ним внутренне — или переживает, когда их проявляет кто-то из близких',
            ],
            'habitual' => [
     ...
     * скрытое напряжение и списком — непроявленные.
     */
